CREATE TABLE `game_categories` (
	...
	`created_at` integer DEFAULT 1756135985725
);
...
CREATE TABLE `post_comments` (
	...
	`created_at` integer DEFAULT 1756135985725,
	`updated_at` integer DEFAULT 1756135985725,
...
CREATE TABLE `__new_posts` (
	...
	`created_at` integer DEFAULT 1756135985724,
	`updated_at` integer DEFAULT 1756135985724
);
--> statement-breakpoint
