...
export function GameProfileForm({
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    // Ensure we submit characters in current order and trimmed
  ...
  // Simple HTML5 drag-and-drop for 3 items
      ...
      <div>
        ...
        <ul className="space-y-2">
          {chars.map((val, i) => (
            ...
            >
              <span className="select-none text-xs text-muted-foreground w-5 text-center">{i + 1}</span>
